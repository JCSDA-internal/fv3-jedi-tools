...
for dt in dts:
  ...
  # Geometry
  inputresolution  = geosconf.geometry_dict('inputresolution' ,'Data/fv3files', cf['levels'])
  outputresolution = geosconf.geometry_dict('outputresolution','Data/fv3files', cf['levels'])
